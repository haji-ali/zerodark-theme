...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(ansi-color-black ((,class (:foreground ,default :background ,background-darker))))
   `(ansi-color-red ((,class (:foreground ,red :background ,background-red))))
   `(ansi-color-green ((,class (:foreground ,green :background ,background-green))))
   `(ansi-color-yellow ((,class (:foreground ,orange :background ,background-orange))))
   `(ansi-color-blue ((,class (:foreground ,blue :background ,background-blue))))
   `(andi-color-magenta ((,class (:foreground ,purple :background ,background-purple))))
   `(ansi-color-cyan ((,class (:foreground ,blue-dark))))
   `(ansi-color-white ((,class (:foreground ,grey))))
